...
public class ResourceManager extends CompositeService implements Recoverable {
  ...
  protected ResourceScheduler createScheduler() {
    ...
    LOG.info("YARN HOUSHITAO---- createScheduler ---- Using Scheduler: " + schedulerClassName);
    try {
  ...
  public class RMActiveServices extends CompositeService {
    ...
    protected void serviceInit(Configuration configuration) throws Exception {
      ...
      LOG.info("1 YARN HOUSHITAO ---- serviceInit createScheduler ----");
      scheduler = createScheduler();
      scheduler.setRMContext(rmContext);
      addIfService(scheduler);
      rmContext.setScheduler(scheduler);
      LOG.info("2 YARN HOUSHITAO ---- serviceInit createSchedulerEventDispatcher ----");
      ...
      public void run() {
        ...
        while (!stopped && !Thread.currentThread().isInterrupted()) {
          try {
            ...
            LOG.info("3 YARN HOUSHITAO EventProcessor event: "+event);
